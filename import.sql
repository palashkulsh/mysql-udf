...
CREATE AGGREGATE FUNCTION realvalformax RETURNS REAL SONAME 'udf_math.so';
CREATE AGGREGATE FUNCTION realvalformin RETURNS REAL SONAME 'udf_math.so';
CREATE AGGREGATE FUNCTION strvalformax RETURNS STRING SONAME 'udf_math.so';
CREATE AGGREGATE FUNCTION strvalformin RETURNS STRING SONAME 'udf_math.so';
CREATE AGGREGATE FUNCTION realvalfordatemax RETURNS REAL SONAME 'udf_math.so';
CREATE AGGREGATE FUNCTION realvalfordatemin RETURNS REAL SONAME 'udf_math.so';
